        ...
        <>
            ...
            <div className=" bg-gray-100 w-full h-auto pt-5  md:w-full md:h-auto ">
                ...
                <ul className="  ml-10 mt-3 text-lg md:ml-60">
                    <li className="m-5 " >
                    1) Avoir le niveau de la 2ème année du baccalauréat, ou être titulaire d’un diplôme de qualification professionnelle reconnu par les pouvoirs publics
                    </li>
                     <li className="m-5">
                     2) Etre âgé de 30 ans au maximum à la date d’inscription
                    </li>
                     <li className="m-5">
                     3) L’accès aux filières est conditionné par le niveau scolaire du candidat
                    </li>
                </ul>
...
<div className="flex justify-center max-[700px]:flex-col">
        ...
        <Cardts
            ...
            title="Technicien en  Secrétariat et Bureautique"
        />
        </Link>
