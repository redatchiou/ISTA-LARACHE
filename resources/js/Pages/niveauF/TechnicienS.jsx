    ...
    return (
        <>
            ...
            <div className=" bg-gray-100 w-full h-auto pt-5  md:w-full md:h-auto ">
                <h5 className="  text-center  text-xl text-blue-600 ">Les conditions pour ce Niveau</h5>
                <ul className="  ml-10 mt-3 text-lg md:ml-60">
                    <li className="m-5">
                    1) Titulaire du baccalauréat, ou d’un diplôme de Technicien reconnu par les pouvoirs publics
                    </li>
                     <li className="m-5">
                     2) Etre âgé de 30 ans au maximum à la date d’inscription
                    </li>
                     <li className="m-5">
                     3) L’accès aux filières est conditionné par un diplôme du baccalauréat pour les bacheliers, <br /> et un diplôme de la licence pour les licenciés
                    </li>
                </ul>
                <h5 className=" text-center  text-xl text-blue-600">Les Filier de ce Niveau </h5>

                <main className="mt-0 mb-4   ">
