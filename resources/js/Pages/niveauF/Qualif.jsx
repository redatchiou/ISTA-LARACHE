        ...
        <>
            ...
            <div className=" bg-gray-100 w-full h-auto pt-5  md:w-full md:h-auto ">
                ...
                <ul className="  ml-10 mt-3 text-lg md:ml-60">
                    <li className="m-5 " >
                    1) Avoir au minimum le niveau de la 3ème année de l’enseignement secondaire collégial ou être titulaire d’un diplôme de spécialisation reconnu par les pouvoirs publics
                    </li>
                     <li className="m-5">
