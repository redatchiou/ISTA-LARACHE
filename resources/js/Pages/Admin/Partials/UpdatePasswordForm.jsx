...
export default function UpdatePasswordForm({ className }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900">Mettre à jour Mot de passe</h2>

                <p className="mt-1 text-sm text-gray-600">
                Assurez-vous que votre compte utilise un long mot de passe pour rester en sécurité.
                </p>
            </header>
